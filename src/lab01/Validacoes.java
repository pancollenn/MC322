...
public class Validacoes {
	...
	public static boolean tudoIgual(String cpfNumerico) {
		int i = 0;
	...
	public static boolean verificarPrimeiro(List<Integer> digitosInt) {
		int digito = 0;
	...
	public static boolean verificarSegundo(List<Integer> digitosInt) {
		int digito = 0;
	...
	public static boolean verificadoresCorretos(String cpfNumerico) {
